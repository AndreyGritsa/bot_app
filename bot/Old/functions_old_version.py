...
def put_all_items_asmo_plus_runic():
    ...
    #put scarhide
    flux = check('scarhide_full_hd.png', 962, 165, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('SplitFullHD.png', 962, 165, 1403, 984)
    ...
    #put smolderhide
    flux = check('smolderhide_full_hd.png', 962, 165, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('SplitFullHD.png', 962, 165, 1403, 984)
    ...
    #put infused leather
    flux = check('infused_leather_full_hd.png', 962, 165, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('SplitFullHD.png', 962, 165, 1403, 984)
...
def full_rotation_asmo(y):
    ...
    while 1:
        ...
        if hz(list_of_nicknames(y), a) >= 2: 
           ...
           accept_trade()
           a = []
           step('stepFullHD.png', 1238, 23, 1765, 216)
        else:
           print(hz(list_of_nicknames(y), a))
...
#function of full rotation for asmo
def full_rotation_asmo_plus_runic(y):
    a = []
    z = []
    while 1:
        print(hz(list_of_nicknames(y), a))
